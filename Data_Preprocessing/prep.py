...
class DataPreprocess():
    ...
    image_viewer_colum = [
        ...
        [sg.Frame("", layout=[[sg.Image(key="-IMAGE-", size=(600, 300))]])],
    ...
    bright_and_contrast_section = [
        ...
        [sg.T(' 0', size=(4, 1), key='-MIN BRIGHT-'),
         sg.Slider((0, 255*2), default_value=0, key='-SLIDER BRIGHT-', orientation='h',
                   enable_events=True, disable_number_display=True),
         sg.T(' 255', size=(4, 1), key='-MAX BRIGHT-')],
        [sg.Text('  contrast'), sg.Text('', key='-TEXT CONTRAST')],
        [sg.T(' 0', size=(4, 1), key='-MIN CONTRAST-'),
         sg.Slider((0, 127*2), default_value=0, key='-SLIDER CONTRAST-', orientation='h',
                   enable_events=True, disable_number_display=True),
         sg.T(' 127', size=(4, 1), key='-MAX CONTRAST-')]
    ]
    ...
    layout_tab = [
        ...
        [sg.Button("Clear", key="-CL-"), sg.Button("Export CSV", key="-CSV-")],
    ]
    ...
    image_viewer_colum_pp = [
        ...
        [
            ...
            sg.Column(layout=([sg.Text("Class:"), sg.Text("", key="-CLASS NAME-", size=(5, 1))],
                              [sg.Combo(values=[], key="-CLASS COMBO-",
                                        enable_events=True, size=(10, 0))])),
            sg.Listbox(values=[], enable_events=True,
                       size=(60, 5), key="-FILE LIST-")
        ],
...
# window_main = sg.Window("AI.EXE", main.Layout(),
#                         resizable=True, finalize=True)
...
#                     window_insert_data["-IMAGE1-"].update(
#                         filename=filename)
#                 except:
#                     pass
#             elif event2 == "-DEL IMG-":
